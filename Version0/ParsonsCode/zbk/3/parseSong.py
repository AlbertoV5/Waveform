...
#freqBands = [i*60 for i in range(2,6)] # Body/Snare
...
for i in range(maxBars//barBlock):
    barNum = i*barBlock
    x,y,z = ez.GetNotesPeaks3D_FreeEnergy(freqBands, song, bpm, barNum, barNum+barBlock, measure, unitSize, noteTR, False)
