...
for i in range(maxBars):
    try:
        x,y,z = ez.GetNotesPeaks3D(freqBands, song, bpm, i, i+1, measure, unitSize, noteTR, False)
...
pc_e,pc_f = parsons.GetPCode(x_energy, y_energy),parsons.GetPCode(x_freq, y_freq)
